...
public class CompatibilityService {
    ...
    private static final Map<String, String> POLICY_DISPLAY_NAMES = Map.ofEntries(
        ...
        Map.entry("caching",                     "3scale Auth Caching"),
        ...
        Map.entry("payload_limits",             "Response/Request Content Limits"),
    ...
    private void checkPolicies(ApiService service, List<CompatibilityItem> items,
        ...
        for (Policy policy : service.policies) {
            ...
            // Upstream: list membership alone is not enough when any rule fails approximation.
            if ("upstream".equals(systemName) && !UpstreamSupport.allRulesConvertible(policy)) {
                items.add(new CompatibilityItem(displayName, "WARNING",
