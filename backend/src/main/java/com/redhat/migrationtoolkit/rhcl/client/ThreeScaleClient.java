...
public interface ThreeScaleClient {
    ...
    Map<String, Object> getServices(
            ...
            @QueryParam("per_page")
            @DefaultValue(ConversionConstants.LIST_PAGE_SIZE_DEFAULT) int perPage);
    ...
    List<Map<String, Object>> getBackendUsages(
    ...
    Map<String, Object> getMappingRules(
            @PathParam("serviceId") String serviceId,
            @QueryParam("access_token") String accessToken,
            @QueryParam("page") @DefaultValue("1") int page,
            @QueryParam("per_page")
    ...
    Map<String, Object> getApplicationKeys(
    ...
    Map<String, Object> getApplicationPlans(
            @PathParam("serviceId") String serviceId,
            @QueryParam("access_token") String accessToken,
            @QueryParam("page") @DefaultValue("1") int page,
            @QueryParam("per_page")
    ...
    Map<String, Object> getApplicationPlanLimits(
